...
class SliderController extends Controller
{
	...
	public function saveImg($file, $route, $nombreImagen)
	{
		...
		$img->coverDown(1440, 1220, 'center');
	...
	public function updateJson(Request $request)
	{
		...
		try {
			...
			$archivoArray['bienvenida']['preTitulo'] = $request->preTitulo;
			$archivoArray['bienvenida']['titulo'] = $request->titulo;
			$archivoArray['bienvenida']['enlacebtn'] = $request->enlacebtn;
			$archivoArray['bienvenida']['textoBtn'] = $request->textoBtn;
			$archivoArray['bienvenida']['extracto'] = $request->extracto;
