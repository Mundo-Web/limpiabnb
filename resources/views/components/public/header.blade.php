      ...
      <div class="md:hidden">
        <button aria-label="hamburguer" class="hamburger onMenu">
          <svg width="50" height="50" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 16H28" stroke="white" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"
              class="menu__blog-azul" />
            <path d="M4 8H28" stroke="white" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"
              class="menu__blog-azul" />
            <path d="M4 24H28" stroke="white" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"
              class="menu__blog-azul" />
          </svg>
